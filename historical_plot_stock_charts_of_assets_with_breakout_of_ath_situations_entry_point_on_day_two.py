...
if __name__=="__main__":
    name_of_folder_where_plots_will_be = 'historical_breakout_of_ath_entry_point_on_day_two'
    db_where_ohlcv_data_for_stocks_is_stored="ohlcv_data_for_usdt_pairs_for_1d_timeframe"
    db_where_levels_formed_by_fast_breakout_of_ath_are_stored="historical_levels_for_cryptos"
